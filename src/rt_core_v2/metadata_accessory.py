...
pretty_print_dict = {
	...
	RtChangeReason.R03: "There is an A1 error in the corresponding A tuple; therefore the NtoRTuple tuple is nonsensical",
	...
	RtChangeReason.P3: "There is an A1 error in the corresponding A tuple; the NtoNTuple tuple is nonsensical",
...
description_dict = {
	...
	RtChangeReason.R03: "There is an A1 error in the corresponding A tuple (the ruin parameter does not refer to any PoR at all); therefore the NtoRTuple tuple is nonsensical",
	...
	RtChangeReason.P3: "There is an A1 error in the corresponding A tuple (one or more of the RUIs in P does not refer at all); therefore the NtoNTuple tuple is nonsensical",
