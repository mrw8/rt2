...
class ATuple(RtTuple):
    ...
    def __init__(
        ...
        # unless we don't get a ruin either, in which case set it to the
        # autogenerated ruin.
        # This means that the default behavior is that if neither Ruia nor ruin
        # are provided, we are assuming some entity is assigning a ruin to
        # itself, and thus should be equal
        self.ruia = ruia if ruia else (Rui() if ruin else (ruin := Rui()))
